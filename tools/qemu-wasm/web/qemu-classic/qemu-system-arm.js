...
var ASM_CONSTS = {
  10366931: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 10367078: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 10367312: ($0) => { if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0; },  
 10367805: () => { var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate; },  
 10367873: ($0, $1, $2, $3) => { var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.silenceTimer = setTimeout(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); } },  
 10369525: ($0, $1, $2, $3) => { var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vi', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']); },  
 10369935: ($0, $1) => { var SDL2 = Module['SDL2']; var numChannels = SDL2.capture.currentCaptureBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.capture.currentCaptureBuffer.getChannelData(c); if (channelData.length != $1) { throw 'Web Audio capture buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } if (numChannels == 1) { for (var j = 0; j < $1; ++j) { setValue($0 + (j * 4), channelData[j], 'float'); } } else { for (var j = 0; j < $1; ++j) { setValue($0 + (((j * numChannels) + c) * 4), channelData[j], 'float'); } } } },  
 10370540: ($0, $1) => { var SDL2 = Module['SDL2']; var numChannels = SDL2.audio.currentOutputBuffer['numberOfChannels']; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.audio.currentOutputBuffer['getChannelData'](c); if (channelData.length != $1) { throw 'Web Audio output buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } for (var j = 0; j < $1; ++j) { channelData[j] = HEAPF32[$0 + ((j*numChannels + c) << 2) >> 2]; } } },  
 10371020: ($0) => { var SDL2 = Module['SDL2']; if ($0) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); } if (SDL2.capture.stream !== undefined) { var tracks = SDL2.capture.stream.getAudioTracks(); for (var i = 0; i < tracks.length; i++) { SDL2.capture.stream.removeTrack(tracks[i]); } SDL2.capture.stream = undefined; } if (SDL2.capture.scriptProcessorNode !== undefined) { SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) {}; SDL2.capture.scriptProcessorNode.disconnect(); SDL2.capture.scriptProcessorNode = undefined; } if (SDL2.capture.mediaStreamNode !== undefined) { SDL2.capture.mediaStreamNode.disconnect(); SDL2.capture.mediaStreamNode = undefined; } if (SDL2.capture.silenceBuffer !== undefined) { SDL2.capture.silenceBuffer = undefined } SDL2.capture = undefined; } else { if (SDL2.audio.scriptProcessorNode != undefined) { SDL2.audio.scriptProcessorNode.disconnect(); SDL2.audio.scriptProcessorNode = undefined; } SDL2.audio = undefined; } if ((SDL2.audioContext !== undefined) && (SDL2.audio === undefined) && (SDL2.capture === undefined)) { SDL2.audioContext.close(); SDL2.audioContext = undefined; } },  
 10372192: ($0, $1, $2) => { var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); SDL2.data32Data = data; } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); },  
 10373661: ($0, $1, $2, $3, $4) => { var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf; },  
 10374650: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 10374733: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 10374802: () => { return window.innerWidth; },  
 10374832: () => { return window.innerHeight; }
};
...
// end include: preamble.js
  ...
  allocateUnusedWorker() {
        ...
        if (!Module['locateFile']) {
          worker = new Worker(new URL('qemu-system-arm.worker.js', import.meta.url), {type: 'module'});
        } else {
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(18, 1, fd, length);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(19, 1, buf, size);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(20, 1, fd, dirp, count);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(22, 1, fd, addr, addrlen, d1, d2, d3);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(23, 1, fd, level, optname, optval, optlen, d1);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(24, 1, fd, op, varargs);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(25, 1, fd, backlog);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(26, 1, path, buf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(27, 1, dirfd, path, mode);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(28, 1, dirfd, path, buf, flags);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(29, 1, dirfd, path, flags, varargs);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(30, 1, fdPtr);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(31, 1, fds, nfds, timeout);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(41, 1, path, size, buf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(42, 1, target, linkpath);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(43, 1, dirfd, path, flags);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(44, 1, dirfd, path, times, flags);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(46, 1, len, prot, flags, fd, offset, allocated, addr);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(48, 1, addr, len, prot, flags, fd, offset);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(49, 1, api);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(50, 1, display, attrib_list, configs, config_size, numConfigs);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(51, 1, display, config, hmm, contextAttribs);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(52, 1, display, config, win, attrib_list);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(53, 1, display, context);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(54, 1, display, surface);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(55, 1, display, config, attribute, value);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(56, 1, nativeDisplayType);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(58, 1, display, majorVersion, minorVersion);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(59, 1, display, draw, read, context);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(60, 1, display, name);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(61, 1, dpy, surface);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(62, 1, display, interval);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(63, 1, display);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(65, 1, nativeEngineId);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(67, 1, target, width, height);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(72, 1, index, gamepadState);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(74, 1, width, height);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(75, 1, target, deferUntilInEventHandler, fullscreenStrategy);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(76, 1, target, deferUntilInEventHandler);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(78, 1, userData, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(80, 1, target, width, height);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(83, 1, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(84, 1, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(99, 1, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(101, 1, title);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(102, 1, __environ, environ_buf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(103, 1, penviron_count, penviron_buf_size);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(104, 1, fd);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(105, 1, fd, pbuf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(106, 1, fd, iov, iovcnt, offset, pnum);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(107, 1, fd, iov, iovcnt, offset, pnum);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(108, 1, fd, iov, iovcnt, pnum);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(109, 1, fd, offset, whence, newOffset);
  ...
  function(fd) {
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(110, 1, fd);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(112, 1, node, service, hint, out);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(113, 1, name);
...
var _pebble_wasm_display_width = Module['_pebble_wasm_display_width'] = createExportWrapper('pebble_wasm_display_width');
var _pebble_wasm_display_height = Module['_pebble_wasm_display_height'] = createExportWrapper('pebble_wasm_display_height');
var _pebble_wasm_display_stride = Module['_pebble_wasm_display_stride'] = createExportWrapper('pebble_wasm_display_stride');
var _pebble_wasm_display_data = Module['_pebble_wasm_display_data'] = createExportWrapper('pebble_wasm_display_data');
var _pebble_wasm_display_frame_count = Module['_pebble_wasm_display_frame_count'] = createExportWrapper('pebble_wasm_display_frame_count');
var _pebble_wasm_button_state_addr = Module['_pebble_wasm_button_state_addr'] = createExportWrapper('pebble_wasm_button_state_addr');
...
var _pebble_wasm_serial_ctrl = Module['_pebble_wasm_serial_ctrl'] = createExportWrapper('pebble_wasm_serial_ctrl');
...
var dynCall_iiiijdd = Module['dynCall_iiiijdd'] = createExportWrapper('dynCall_iiiijdd');
...
var ___start_em_js = Module['___start_em_js'] = 10356522;
var ___stop_em_js = Module['___stop_em_js'] = 10366931;
